...
CREATE TABLE IF NOT EXISTS ocupacional_orden_detalle (
  ...
  grupo_snapshot VARCHAR(100) NULL,
  subgrupo_snapshot VARCHAR(100) NULL,
  grupo_orden_snapshot INT NOT NULL DEFAULT 0,
  examen_orden_snapshot INT NOT NULL DEFAULT 0,
  monto DECIMAL(10,2) NOT NULL DEFAULT 0.00,
